			...
			<table class="table table-hover">
				...
				<tbody class="table-group-divider">
					<tr>
						...
						<td>견주신청(2)</td>
						<td><button type="button" class="btn btn-primary" onclick="javascript:btn('예약이 확정되었습니다.')">예약확정하기</button></td>
					</tr>
					<tr>
						<td>윤건하</td>
						<td>멍멍이</td>
						<td>2023-07-18 18:30~19:00</td>
						<td>산책자신청(1)</td>
						<td><button type="button" class="btn btn-primary" disabled>예약확정됨</button>
							<!-- 모달 시작 -->
								<button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#exampleModal">예약취소하기</button>	
					...
					<tr>
						...
						<td>2023-07-18 18:30~19:00</td>
						<td>산책자신청(1)</td>
						<td><button type="button" class="btn btn-primary" disabled>거절됨</button></td>
					</tr>
					<tr>
						<td>윤건하</td>
						<td>멍멍이</td>
					...
					<tr>
						...
						<td>2023-07-18 18:30~19:00</td>
						<td>산책자신청(1)</td>
						<td><button type="button" class="btn btn-primary" disabled>거절함</button></td>
					</tr>
					<tr>
						<td>윤건하</td>
						<td>멍멍이</td>
