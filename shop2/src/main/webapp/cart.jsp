            ...
            <div class="col-lg-8 mb-4 mb-lg-0">
                  ...
                  <tbody class="border-0">                
					...
					<!-- 상품 이미지및 이름 -->
					   <th class="ps-0 py-3 border-light" scope="row">
                        <div class="d-flex align-items-center"><a class="reset-anchor d-block animsition-link" href="detail.html"><img src="https://img.biteme.co.kr/product/750/3fa3e3885078af3dc932bdcfe13cf55c.jpg" alt="..." width="70"/></a>
                          <div class="ms-3"><strong class="h6"><a class="reset-anchor animsition-link" href="detail.html" id="pname">로얄캐닌 미니 인도어 퍼피</a></strong></div>
                        </div>                                  
                      </th>
					...
					<td class="p-3 align-middle border-0">
					  ...
					  <td class="p-3 align-middle border-light">
					    <p class="mb-0 small" id="p_sum1">원</p>
					  </td>					
					  <!-- 삭제 버튼 -->
					  <td class="p-3 align-middle border-light">
					    <a class="reset-anchor" href="#!" onclick="deleteRow(this)"><i class="fas fa-trash-alt small text-muted"></i></a>
					  </td>
					</tr>
						...
						<tr id="cart2">
						  <th class="ps-0 py-3 border-light" scope="row">
						    <div class="d-flex align-items-center">
						      ...
						      <div class="ms-3">
						        <strong class="h6">
						          <a class="reset-anchor animsition-link" href="detail.html" id="pname2">로얄캐닌 미니 인도어 퍼피</a>
						        </strong>
						      </div>
						    </div>
						  </th>
						  <td class="p-3 align-middle border-0">
						    <p class="mb-0 small">9900원</p>
						  </td>
						  <!-- 수량 입력 -->
						  <td class="p-3 align-middle border-0">
						    <div class="border d-flex align-items-center justify-content-between px-3">
						  ...
						  <!-- 가격 표시 -->
						  <td class="p-3 align-middle border-light">
						    <p class="mb-0 small" id="p_sum2">원</p>
						  </td>
						  <!-- 삭제 버튼 -->
						  <td class="p-3 align-middle border-light">
						    <a class="reset-anchor" href="#!" onclick="deleteRow(this)" id="del"><i class="fas fa-trash-alt small text-muted"></i></a>
						  </td>
						</tr>
              ...
              <div class="bg-light px-4 py-3">
                <div class="row align-items-center text-center">
                  <div class="col-md-6 mb-3 mb-md-0 text-md-start"><a class="btn btn-link p-0 text-dark btn-sm" href="product_list.jsp"><i class="fas fa-long-arrow-alt-left me-2"> </i>쇼핑계속하기</a></div>
                  <div class="col-md-6 text-md-end"><a class="btn btn-outline-dark btn-sm" href="order_page.jsp">구매하기<i class="fas fa-long-arrow-alt-right ms-2"></i></a></div>
                </div>
              </div>
            </div>
            <!-- ORDER TOTAL-->
