...
<tr valign="middle" bgcolor="#ffffff"><td>
	...
	<div class="container border border-2 cm-1">
		...
		<div class="row">
			<div class="col-1">
				<img src="img/n1.png" class="float-end" style="width: 40px;" alt="...">
			</div>
			<div class="col-2">
				<h2>날짜 선택</h2>
			</div>
		...
		<!-- 지도 시작 -->
		<div class="row">
			<div class="col-1"><img src="img/n2.png" class="float-end" style="width: 40px;" alt="..."></div>
			<div class="col-10">
		...
		<div class="container">
			<div class="row">
				<div class="col-1"><img src="img/n3.png" class="float-end" style="width: 40px;" alt="..."></div>
				<div class="col-2">
					<h5>산책 시작 시간</h5>
					<p>
					<h5>산책 종료 시간</h5>
