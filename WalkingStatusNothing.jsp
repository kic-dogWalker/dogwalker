...
<tr valign="middle" bgcolor="#ffffff"><td>
	...
	<div class="container text-center border border-2 cm-1">
		...
		<p>
		<div class="row">
			<div class="col"><img src="img/LD.png" alt="..."></div>
		</div><!-- row -->
		<p>
		<div class="row">
		...
		<p>
			<div class="row">
				<div class="col-2"></div>
				<div class="col-4"><img src="img/not.png" style="width: 300px;" class="rounded-circle" alt="..."></div>
				<div class="col-4"><img src="img/not.png" style="width: 300px;" class="rounded-circle" alt="..."></div>
				<div class="col-2"></div>
			</div><!-- row -->
			<div class="row">
			...
			<div class="row">
			<div class="col-4"></div>
				<div class="col-4"><button type="button" class="btn btn-primary">예약신청 하러 가기</button></div>
				<div class="col-4"></div>
			</div><!-- row -->
			<div class="row">
			<p>
