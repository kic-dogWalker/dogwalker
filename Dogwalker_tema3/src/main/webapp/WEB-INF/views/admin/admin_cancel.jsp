				...
				<li class="header-nav-brand">
					<div class="brand-holder">
						<span class="location_text">
							<a href="/admin/shopping/cancel">취소관리</a>						</span>
					</div>
				</li>
			</ul>
		</div>
		<div class="headerbar-right">
			<div class="header-nav header-text hidden-sm hidden-xs">
			</div>
		</div>
	</div>
</header>
			...
			<div class="holder">
				<ul class="tw-flex nav nav-tabs tw-mb-[12px]" id="order_status_tab">
					<li class="owl_dashboard _owl_dashboard owl-carousel owl-theme owl-loaded">
													...
													<div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 504px;"><div class="owl-item active" style="width: auto; margin-right: 0px;"><ul class="owl-nav-tabs">
									<li class="active _NEW"><a href="#" onclick="location.href='/admin/shopping/cancel?status=NEW&amp;reset_status=N'">신규취소 <span class="_count text-primary">0</span></a></li>
								</ul></div><div class="owl-item active" style="width: auto; margin-right: 0px;"><ul class="owl-nav-tabs">
									<li class=" _CANCEL_REQUEST"><a href="#" onclick="location.href='/admin/shopping/cancel?status=CANCEL_REQUEST&amp;reset_status=N'">취소요청 <span class="_count text-primary">0</span></a></li>
								</ul></div><div class="owl-item active" style="width: auto; margin-right: 0px;"><ul class="owl-nav-tabs">
									<li class=" _CANCELING"><a href="#" onclick="location.href='/admin/shopping/cancel?status=CANCELING&amp;reset_status=N'">취소처리중 <span class="_count text-primary">0</span></a></li>
								</ul></div><div class="owl-item active" style="width: auto; margin-right: 0px;"><ul class="owl-nav-tabs">
									<li class=" _CANCEL_FAILED"><a href="#" onclick="location.href='/admin/shopping/cancel?status=CANCEL_FAILED&amp;reset_status=N'">취소처리실패 <span class="_count text-primary">0</span></a></li>
								</ul></div><div class="owl-item active" style="width: auto; margin-right: 0px;"><ul class="owl-nav-tabs">
									<li class=" _CANCEL"><a href="#" onclick="location.href='/admin/shopping/cancel?status=CANCEL&amp;reset_status=N'">취소완료 <span class="_count text-primary">0</span></a></li>
								</ul></div></div></div><div class="owl-controls"><div class="owl-nav"><div class="owl-prev" style="display: none;">prev</div><div class="owl-next" style="display: none;">next</div></div><div class="owl-dots" style=""><div class="owl-dot active"><span></span></div><div class="owl-dot"><span></span></div><div class="owl-dot"><span></span></div><div class="owl-dot"><span></span></div><div class="owl-dot"><span></span></div></div></div></li>
                    									</ul>
			</div>
			<div class="row">
				<div class="col-md-12">
						...
						<div class="table-responsive shop-table orders check " id="order_list"><!-- check class 추가시 테이블 헤더 변경됨 --->
							<div class="table-btn-group">
								<div class="btn-group-left">
									<div class="btn-group">
										<a href="javascript:;" onclick="SHOP_ORDER_MANAGE.runOrderAction('CANCEL_ACCEPT')" class="btn btn-primary btn-sm btn-sm-padding" data-toggle="tooltip" data-placement="top" title="" data-original-title="취소요청건에 대해 환불처리를 진행합니다.">취소승인</a>
										<a href="javascript:;" onclick="SHOP_ORDER_MANAGE.runOrderAction('CANCEL_REJECT')" class="btn btn-white btn-sm btn-sm-padding" data-toggle="tooltip" data-placement="top" title="" data-original-title="취소요청건을 거절하고 발송처리 합니다.">취소거절</a>
																				<div class="holder inline-blocked btn btn-white btn-sm btn-sm-padding">
											<a href="javascript:;" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">기타 취소처리 <span class="caret"></span></a>
											<ul class="dropdown-menu">
												<li><a href="javascript:;" onclick="SHOP_ORDER_MANAGE.runOrderAction('RESTORE_CANCELING')" data-toggle="tooltip" data-placement="right" title="" data-original-title="취소완료건을 취소처리중으로 되돌립니다. 이미 환불이 완료된 경우 대금 회수는 되지 않습니다.">취소처리중으로 되돌리기</a></li>
												<li><a href="javascript:;" onclick="SHOP_ORDER_MANAGE.runOrderAction('RESTORE_CANCEL_REQUEST')" data-toggle="tooltip" data-placement="right" title="" data-original-title="취소완료, 취소처리중을 취소요청으로 되돌립니다. 이미 환불이 완료된 경우 대금 회수는 되지 않습니다.">취소요청으로 되돌리기</a></li>
												<li><a href="javascript:;" onclick="SHOP_ORDER_MANAGE.runOrderAction('CANCEL_RETRY')" data-toggle="tooltip" data-placement="right" title="" data-original-title="자동환불 가능(카드결제 전체취소) 취소승인을 하였으나 PG사 장애 등의 이유로 취소처리중이 되었을 때 자동 환불을 다시 시도하는 기능입니다.">자동환불 재시도</a></li>
												<li><a href="javascript:;" onclick="SHOP_ORDER_MANAGE.runOrderAction('CANCEL_FORCE_DONE')" data-toggle="tooltip" data-placement="right" title="" data-original-title="자동환불이 불가한 경우 수동으로 실제 환불을 처리하신 후 주문서를 취소완료 상태로 변경하는 기능입니다. 자동환불이 진행되지 않으므로 구매자와 협의된 방법으로 환불을 별도 진행해 주셔야 합니다.">강제 취소(환불)완료 처리</a></li>
											</ul>
										</div>
										<a href="javascript:;" onclick="SHOP_ORDER_MANAGE.showOrderHelp('cancel')" class="btn btn-sm btn-flat" style="padding:2px 5px; color:#313534"><i class="btl bt-question-circle"></i> 취소처리 도움말</a>
									</div>
								</div>
									...
									<div class="holder inline-blocked blocked-xs">
										<form role="search" class="prod-search" id="order_search_form" onsubmit="return false;">
											<div class="inline-blocked holder">
                                                ...
                                                <input type="text" class="form-control typeahead tt-input _keyword_search" style="padding-right: 30px;" autocomplete="off" spellcheck="false" dir="auto" onkeydown="if (event.keyCode==13) SHOP_ORDER_MANAGE.startKeywordSearch()" value="" placeholder="주문번호, 주문자명, 연락처">
											...
											<a class="btn btn-primary btn-flat xs-padding-x" href="javascript:;" onclick="SHOP_ORDER_MANAGE.openModalOrderAdvancedSearch('cancel', 'YjowOw==')">고급</a>
										</form>
									</div>
									<div class="btn-group holder inline-blocked excel_down_btn">
										<form id="formOrderPrintMulti" action="/admin/ajax/shop/get_order_print_popup.cm" method="post" target="order_print_popup"></form>
                                                                                    <a href="javascript:;" onclick="SHOP_ORDER_MANAGE.openOrderPrintPopup()" type="button" class="btn btn-sm btn-sm-padding btn-default-bright">주문서 출력</a>
                                        																					<a href="javascript:;" onclick="SHOP_ORDER_MANAGE.openModalOrderExcelDownload('cancel', 'YjowOw==')" type="button" class="btn btn-sm btn-sm-padding btn-default-bright">
							...
							<div class="card style-transparent card-top no-tab" style="display: none" id="order_list_empty">
								<div class="card-head">
									<header class="style-price-header text-gray-bright force-padding" style="padding-top: 64px; padding-bottom: 90px;">
										<h4>조회할 데이터가 없습니다.</h4>
									</header>
								</div>
							</div>
							<div class="card style-transparent card-top no-tab" style="" id="order_list_empty_new">
								<div class="card-head">
									<header class="style-price-header text-gray-bright force-padding" style="padding-top: 64px; padding-bottom: 90px;">
										<h4 style="margin-bottom: 8px;">처리하실 취소주문이 없습니다.</h4>
										<p class="text-14">처리하신 주문은 <a href="/admin/shopping/cancel/?q=YjowOw%3D%3D&amp;status=EXCHANGE&amp;reset_status=N" class="text-primary">취소완료</a>에서 확인하실 수 있습니다.</p>
									</header>
								</div>
							</div>
							...
							<div class="table-responsive table-responsive-order-list" id="order_list_wrap" style="display: none">
								<table class="table table-order-list full-width full-height no-margin" style="min-width: 1306px;">
									<colgroup>
										<col style="width: 30px;">
										<col style="width: 112px; min-width: 112px;">
										<col class="td-order-img-col">
										<col style="width: 220px; min-width: 150px;">
...
<script>
	$(function(){
		SHOP_ORDER_MANAGE.initList('cancel');
		SHOP_ORDER_MANAGE.loadCancelList('1', {'status':'NEW','s_unitcode':'','keyword':'', 's_type': '', 's_filter': '', 'pagesize': '20'}, "/admin/shopping/cancel/?q=YjowOw%3D%3D");
	});
...
<script>
</script><div style="position: absolute; width: 1px; height: 1px; left: -10000px;" data-ip="220.117.144.98" data-ip2="" data-ip3="220.117.144.98, 130.176.126.153"><input id="dummy_input" type="text"></div>
