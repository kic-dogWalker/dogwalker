...
</script><!--예약관리 기능 개편 작업이 진행중입니다. 일시적으로 사용이 불가능합니다 (04:00~05:00). 이용에 불편을 드려 죄송합니다-->
				...
				<li class="header-nav-brand">
					<div class="brand-holder">
						<span class="location_text">
							<a href="/admin/booking/order_cal">예약 현황 관리</a>						</span>
					</div>
				</li>
			</ul>
		</div>
...
<div id="content"><div id="alertBox" class="alert__wrap">    </div>
	<section>
		<div class="section-body">
			<form method="post" class="form form-validate form-horzontal" autocomplete="off" novalidate="novalidate">
				<div class="row">
					<div class="col-md-9" id="manage_calendar">
						<style>

</style>
<div class="booking-order style-default-bright">
	<div class="card-head style-default-light ">
		<h3 class="text-center" style="margin: 14px 0">
			<a href="javascript:;" class="btl bt-angle-left" style="padding: 2px 12px;" onclick="BOOKING_MANAGE.getMonth('2023-06')"></a>
			<span style="padding: 0 15px;">2023. 07</span>
			<a href="javascript:;" class="btl bt-angle-right" style="padding: 2px 12px;" onclick="BOOKING_MANAGE.getMonth('2023-08')"></a>
		</h3>
		<ul class="inline-blocked no-padding no-margin clearfix">
			<li class="text-accent float_l text-12">예약완료</li>
			<li class="text-gray-bright float_l text-12">예약대기</li>
			<li class="float_l text-12">예약가능</li>
		</ul>
	</div>
	<div class="card-body no-padding">
		<div class="calendar-table table-responsive">
			<table>
				<thead>
				<tr>
					<td class="booking_head_container">
				...
				<tr>
					<td>
						<div class="calendar-row">
							<table>
								<tbody>
								<tr><td class="booking_day pc_day  full_day holiday _1687618800 _day_td"><div class="">
	<div class="calendar-bg">
		<a href="javascript:;" onclick="BOOKING_MANAGE.viewDay('1687618800')"></a>
	</div>

	<div class="day-number">
		<span>25</span>
		<span class="text-gray-bright float_r text-12"></span>
	</div>

	<div class="min_table"></div></div></td><td class="booking_day pc_day  full_day _1687705200 _day_td"><div class="">
	<div class="calendar-bg">
		<a href="javascript:;" onclick="BOOKING_MANAGE.viewDay('1687705200')"></a>
	</div>
	...
	<div class="min_table"></div></div></td><td class="booking_day pc_day  full_day _1687791600 _day_td"><div class="">
	<div class="calendar-bg">
		<a href="javascript:;" onclick="BOOKING_MANAGE.viewDay('1687791600')"></a>
	</div>
	...
	<div class="min_table"></div></div></td><td class="booking_day pc_day  full_day _1687878000 _day_td"><div class="">
	<div class="calendar-bg">
		<a href="javascript:;" onclick="BOOKING_MANAGE.viewDay('1687878000')"></a>
	</div>
	...
	<div class="min_table"></div></div></td><td class="booking_day pc_day  full_day _1687964400 _day_td"><div class="">
	<div class="calendar-bg">
		<a href="javascript:;" onclick="BOOKING_MANAGE.viewDay('1687964400')"></a>
	</div>
	...
	<div class="min_table"></div></div></td><td class="booking_day pc_day  full_day _1688050800 _day_td"><div class="">
	<div class="calendar-bg">
		<a href="javascript:;" onclick="BOOKING_MANAGE.viewDay('1688050800')"></a>
	</div>
	...
	<div class="min_table"></div></div></td><td class="booking_day pc_day  full_day _1688137200 _day_td"><div class="">
	<div class="calendar-bg">
		<a href="javascript:;" onclick="BOOKING_MANAGE.viewDay('1688137200')"></a>
	</div>
	...
	<div class="min_table"></div></div></td></tr><tr><td class="booking_day pc_day  full_day holiday _1688223600 _day_td"><div class="">
	<div class="calendar-bg">
		<a href="javascript:;" onclick="BOOKING_MANAGE.viewDay('1688223600')"></a>
	</div>
	...
	<div class="min_table"></div></div></td><td class="booking_day pc_day  full_day _1688310000 _day_td"><div class="">
	<div class="calendar-bg">
		<a href="javascript:;" onclick="BOOKING_MANAGE.viewDay('1688310000')"></a>
	</div>
	...
	<div class="min_table"></div></div></td><td class="booking_day pc_day  full_day _1688396400 _day_td"><div class="">
	<div class="calendar-bg">
		<a href="javascript:;" onclick="BOOKING_MANAGE.viewDay('1688396400')"></a>
	</div>
	...
	<div class="min_table"></div></div></td><td class="booking_day pc_day  full_day _1688482800 _day_td"><div class="">
	<div class="calendar-bg">
		<a href="javascript:;" onclick="BOOKING_MANAGE.viewDay('1688482800')"></a>
	</div>
	...
	<div class="min_table"></div></div></td><td class="booking_day pc_day  full_day _1688569200 _day_td"><div class="">
	<div class="calendar-bg">
		<a href="javascript:;" onclick="BOOKING_MANAGE.viewDay('1688569200')"></a>
	</div>
	...
	<div class="min_table"></div></div></td><td class="booking_day pc_day  full_day _1688655600 _day_td"><div class="">
	<div class="calendar-bg">
		<a href="javascript:;" onclick="BOOKING_MANAGE.viewDay('1688655600')"></a>
	</div>
	...
	<div class="min_table"></div></div></td><td class="booking_day pc_day  full_day _1688742000 _day_td"><div class="">
	<div class="calendar-bg">
		<a href="javascript:;" onclick="BOOKING_MANAGE.viewDay('1688742000')"></a>
	</div>
	...
	<div class="min_table"></div></div></td></tr><tr><td class="booking_day pc_day  full_day holiday _1688828400 _day_td"><div class="">
	<div class="calendar-bg">
		<a href="javascript:;" onclick="BOOKING_MANAGE.viewDay('1688828400')"></a>
	</div>
	...
	<div class="min_table"></div></div></td><td class="booking_day pc_day  full_day _1688914800 _day_td"><div class="">
	<div class="calendar-bg">
		<a href="javascript:;" onclick="BOOKING_MANAGE.viewDay('1688914800')"></a>
	</div>
	...
	<div class="min_table"></div></div></td><td class="booking_day pc_day  full_day _1689001200 _day_td"><div class="">
	<div class="calendar-bg">
		<a href="javascript:;" onclick="BOOKING_MANAGE.viewDay('1689001200')"></a>
	</div>
	...
	<div class="min_table"></div></div></td><td class="booking_day pc_day  full_day _1689087600 _day_td"><div class="">
	<div class="calendar-bg">
		<a href="javascript:;" onclick="BOOKING_MANAGE.viewDay('1689087600')"></a>
	</div>
	...
	<div class="min_table"></div></div></td><td class="booking_day pc_day  full_day _1689174000 _day_td"><div class="">
	<div class="calendar-bg">
		<a href="javascript:;" onclick="BOOKING_MANAGE.viewDay('1689174000')"></a>
	</div>
	...
	<div class="min_table"></div></div></td><td class="booking_day pc_day  full_day _1689260400 _day_td"><div class="">
	<div class="calendar-bg">
		<a href="javascript:;" onclick="BOOKING_MANAGE.viewDay('1689260400')"></a>
	</div>
	...
	<div class="min_table"></div></div></td><td class="booking_day pc_day  full_day _1689346800 _day_td"><div class="">
	<div class="calendar-bg">
		<a href="javascript:;" onclick="BOOKING_MANAGE.viewDay('1689346800')"></a>
	</div>
	...
	<div class="min_table"></div></div></td></tr><tr><td class="booking_day pc_day  full_day holiday _1689433200 _day_td"><div class="">
	<div class="calendar-bg">
		<a href="javascript:;" onclick="BOOKING_MANAGE.viewDay('1689433200')"></a>
	</div>
	...
	<div class="min_table"></div></div></td><td class="booking_day pc_day  full_day _1689519600 _day_td"><div class="">
	<div class="calendar-bg">
		<a href="javascript:;" onclick="BOOKING_MANAGE.viewDay('1689519600')"></a>
	</div>
	...
	<div class="min_table"></div></div></td><td class="booking_day pc_day  full_day _1689606000 _day_td"><div class="">
	<div class="calendar-bg">
		<a href="javascript:;" onclick="BOOKING_MANAGE.viewDay('1689606000')"></a>
	</div>
	...
	<div class="min_table"></div></div></td><td class="booking_day pc_day  full_day _1689692400 _day_td"><div class="">
	<div class="calendar-bg">
		<a href="javascript:;" onclick="BOOKING_MANAGE.viewDay('1689692400')"></a>
	</div>
	...
	<div class="min_table"></div></div></td><td class="booking_day pc_day  full_day _1689778800 _day_td"><div class="">
	<div class="calendar-bg">
		<a href="javascript:;" onclick="BOOKING_MANAGE.viewDay('1689778800')"></a>
	</div>
	...
	<div class="min_table"></div></div></td><td class="booking_day pc_day  full_day _1689865200 _day_td"><div class="">
	<div class="calendar-bg">
		<a href="javascript:;" onclick="BOOKING_MANAGE.viewDay('1689865200')"></a>
	</div>
	...
	<div class="min_table"></div></div></td><td class="booking_day pc_day  full_day _1689951600 _day_td"><div class="">
	<div class="calendar-bg">
		<a href="javascript:;" onclick="BOOKING_MANAGE.viewDay('1689951600')"></a>
	</div>
	...
	<div class="min_table"></div></div></td></tr><tr><td class="booking_day pc_day  full_day holiday _1690038000 _day_td"><div class="">
	<div class="calendar-bg">
		<a href="javascript:;" onclick="BOOKING_MANAGE.viewDay('1690038000')"></a>
	</div>
	...
	<div class="min_table"></div></div></td><td class="booking_day pc_day  full_day _1690124400 _day_td"><div class="">
	<div class="calendar-bg">
		<a href="javascript:;" onclick="BOOKING_MANAGE.viewDay('1690124400')"></a>
	</div>
	...
	<div class="min_table"></div></div></td><td class="booking_day pc_day  full_day _1690210800 _day_td"><div class="">
	<div class="calendar-bg">
		<a href="javascript:;" onclick="BOOKING_MANAGE.viewDay('1690210800')"></a>
	</div>
	...
	<div class="min_table"></div></div></td><td class="booking_day pc_day  full_day _1690297200 _day_td"><div class="">
	<div class="calendar-bg">
		<a href="javascript:;" onclick="BOOKING_MANAGE.viewDay('1690297200')"></a>
	</div>
	...
	<div class="min_table"></div></div></td><td class="booking_day pc_day  full_day _1690383600 _day_td"><div class="">
	<div class="calendar-bg">
		<a href="javascript:;" onclick="BOOKING_MANAGE.viewDay('1690383600')"></a>
	</div>
	...
	<div class="min_table"></div></div></td><td class="booking_day pc_day  today _1690470000 _day_td"><div class="">
	<div class="calendar-bg">
		<a href="javascript:;" onclick="BOOKING_MANAGE.viewDay('1690470000')"></a>
	</div>
	...
	<div class="min_table"></div></div></td><td class="booking_day pc_day  _1690556400 _day_td"><div class="">
	<div class="calendar-bg">
		<a href="javascript:;" onclick="BOOKING_MANAGE.viewDay('1690556400')"></a>
	</div>
	...
	<div class="min_table"></div></div></td></tr><tr><td class="booking_day pc_day  holiday _1690642800 _day_td"><div class="">
	<div class="calendar-bg">
		<a href="javascript:;" onclick="BOOKING_MANAGE.viewDay('1690642800')"></a>
	</div>
	...
	<div class="min_table"></div></div></td><td class="booking_day pc_day  _1690729200 _day_td"><div class="">
	<div class="calendar-bg">
		<a href="javascript:;" onclick="BOOKING_MANAGE.viewDay('1690729200')"></a>
	</div>
	...
	<div class="min_table"></div></div></td><td class="booking_day pc_day  _1690815600 _day_td"><div class="">
	<div class="calendar-bg">
		<a href="javascript:;" onclick="BOOKING_MANAGE.viewDay('1690815600')"></a>
	</div>
	...
	<div class="min_table"></div></div></td><td class="booking_day pc_day  _1690902000 _day_td"><div class="">
	<div class="calendar-bg">
		<a href="javascript:;" onclick="BOOKING_MANAGE.viewDay('1690902000')"></a>
	</div>
	...
	<div class="min_table"></div></div></td><td class="booking_day pc_day  _1690988400 _day_td"><div class="">
	<div class="calendar-bg">
		<a href="javascript:;" onclick="BOOKING_MANAGE.viewDay('1690988400')"></a>
	</div>
	...
	<div class="min_table"></div></div></td><td class="booking_day pc_day  _1691074800 _day_td"><div class="">
	<div class="calendar-bg">
		<a href="javascript:;" onclick="BOOKING_MANAGE.viewDay('1691074800')"></a>
	</div>
	...
	<div class="min_table"></div></div></td><td class="booking_day pc_day  _1691161200 _day_td"><div class="">
	<div class="calendar-bg">
		<a href="javascript:;" onclick="BOOKING_MANAGE.viewDay('1691161200')"></a>
	</div>
	...
	<div class="min_table"></div></div></td></tr>								</tbody>
							</table>
						</div>
					</td>
				</tr>
...
<script>
	$(function(){
		BOOKING_MANAGE.init();
					...
					<div class="col-md-3" id="manage_day_info">
						<div class="card">
	<div class="card-head">
		<header>2023-07-28</header>
		<div class="btn btn-sm btn-sm-padding btn-default-bright" id="printBtn" onclick="BOOKING_MANAGE.openBookingPrintPopup()">인쇄하기</div>
 
	<input type="hidden" name="select_timestamp" value="1690470000">
