...
<body class="menubar-hoverable header-fixed menubar-pin">
          ...
          <li class="header-nav-brand">
            <div class="brand-holder">
						<span class="location_text">
							<a href="/admin/shopping/answers">문의관리</a>						</span>
            </div>
          </li>
        </ul>
      </div>
      ...
      <div class="headerbar-right">
        <ul class="header-nav header-nav-options">
          <li>
            ...
            <div class="btn-group">
              <a data-toggle="dropdown" class="btn btn-default-bright border-radius-right">문의 상태변경                <i class="zmdi zmdi-caret-down"></i></a>
              <ul aria-labelledby="dLabel" role="menu" class="dropdown-menu animation-dock check">
                <li>
                  <a href="#" onclick="CONTENTS_LIST.checkActionWithReviewCode(function(codes){SHOP_ANSWERS_MANAGE.updateQnaStatusForm('complete',codes);})">답변완료 처리</a>
                </li>
                <li>
                  <a href="#" onclick="CONTENTS_LIST.checkActionWithReviewCode(function(codes){SHOP_ANSWERS_MANAGE.updateQnaStatusForm('wait',codes);})">답변대기 처리</a>
                </li>
              </ul>
            </div>
            <div class="btn-group">
              <a data-toggle="dropdown" class="btn btn-default-bright border-radius-right">비밀문의 설정/해제                <i class="zmdi zmdi-caret-down"></i></a>
              <ul aria-labelledby="dLabel" role="menu" class="dropdown-menu animation-dock check">
                <li>
                  <a href="#" onclick="CONTENTS_LIST.checkActionWithReviewCode(function(codes){SHOP_ANSWERS_MANAGE.updateQnaSecretForm('Y',codes);})">비밀문의 설정</a>
                </li>
                <li>
                  <a href="#" onclick="CONTENTS_LIST.checkActionWithReviewCode(function(codes){SHOP_ANSWERS_MANAGE.updateQnaSecretForm('N',codes);})">비밀문의 해제</a>
                </li>
              </ul>
            </div>
          </li>
      ...
      <div class="section-body">
        <div class="row">
          <div class="col-md-12">
              ...
              <div class="dropdown card qna-filter" style="padding:0;">
                <button type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="form-control qna-filter-btn" style="height: 48px !important;">
                  <span style="padding-left: 20px;">필터</span>
                  <div class="caret"></div>
                </button>
                <ul class="dropdown-menu" role="menu">
                  <form id="search_qna_form" method="post" tabindex="hidden_frame" action="./qna/qna_search.cm">
                    <li class="qna-list">
                      <div class="down-btn">
                        <select class="form-control" name="qna_status" id="qna_status" onclick="event.cancelBubble=true;" autocomplete="off">
                          <option value="">문의 상태</option>
                    ...
                    <li class="qna-list">
                      <div class="down-btn">
                        <select class="form-control" name="qna_type" id="qna_type" onclick="event.cancelBubble=true;" autocomplete="off">
                          <option value="">문의 유형</option>
                          <option value="normal">일반문의</option>
                          <option value="photo">포토문의</option>
                                                          <option value="npay">네이버페이 문의</option>
                                                    </select>
                      </div>
                    </li>
                    <li class="qna-list">
                      <div class="down-btn">
                        <select class="form-control" name="qna_secret" id="qna_secret" onclick="event.cancelBubble=true;" autocomplete="off">
                          <option value="">비밀문의 여부</option>
                          <option value="secret">비밀문의</option>
                          <option value="no_secret">공개문의</option>
                        </select>
                      </div>
                    </li>
                    <li class="qna-list">
                    ...
                    <li class="qna-list">
                      <div class="down-btn">
                        <input type="text" class="form-control" name="end_time" id="end_time" placeholder="검색할 기간의 종료일" autocomplete="off" value="">
                                          ...
                                          <li class="qna-list">
                      <input type="text" name="qna_nick" id="qna_nick" class="form-control" placeholder="작성자명" autocomplete="off" value="">
                    </li>
                    <li class="qna-list">
                      <input type="text" name="qna_prod_name" id="qna_prod_name" class="form-control" placeholder="상품명" autocomplete="off" value="">
                    </li>
                    <div class="height-1"></div>
                    <div style="text-align:right;">
                      <a href="javascript:;" class="btn-default" onclick="SHOP_ANSWERS_MANAGE.qnaFilterReset(); return false;">초기화</a>
                      <a href="javascript:;" class="btn-primary" onclick="SHOP_ANSWERS_MANAGE.qnaSearchByFilter('search'); return false;">검색</a>
                    </div>
                  </form>
                </ul>
              </div>
                  ...
                  <form role="search" class="user-search" onsubmit="return false;">
                    <div class="form-group">
									<span class="twitter-typeahead" style="position: relative; display: inline-block;">
										<input type="text" id="keyword" class="form-control typeahead tt-input" placeholder="문의 제목, 내용 검색" autocomplete="off" spellcheck="false" dir="auto" onkeydown="if (event.keyCode==13) SHOP_ANSWERS_MANAGE.qnaSearchByFilter('search', '', 'keyword_input');">
									</span>
                      <label class="icon_set" style="right: 18px" onclick="SHOP_ANSWERS_MANAGE.qnaSearchByFilter('search', '', 'keyword_input');">
              ...
              <div class="excel-button">
                ...
                <select name="pagesize" id="pagesize" onchange="SHOP_ANSWERS_MANAGE.qnaSearchByFilter('search')" class="form-control text-13">
  ...
  <style>
        #qna_list .list-comments > li {
      border-top : 1px solid #eee;
    }

    #qna_list .list-comments > li:first-child {
      border-top : 0;
    }

    #qna_filter_list_chosen .chosen-drop {
      display : none;
    }

    .qna-filter .dropdown-menu {
      min-width : 250px;
    }
