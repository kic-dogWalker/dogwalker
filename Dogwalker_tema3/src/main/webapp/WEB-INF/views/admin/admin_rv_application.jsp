				...
				<li class="header-nav-brand">
					<div class="brand-holder">
						<span class="location_text">
							<a href="/admin/booking/order">예약 신청 관리</a>						</span>
					</div>
				</li>
			</ul>
		</div>
		...
		<div class="section-body">
			<div class="row">
				<div class="col-md-12 col-xs-12">
					<ul class="nav nav-tabs" data-toggle="tabs" style="margin-bottom: 24px;" id="order_status_tab">
						<li class="owl_dashboard _owl_dashboard owl-carousel owl-theme owl-loaded">
													<div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 664px;"><div class="owl-item active" style="width: auto; margin-right: 0px;"><ul class="owl-nav-tabs"><li class=" _all"><a href="#" onclick="location.href='./order?status=all&amp;q_enc=YjowOw%3D%3D'" data-name="전체" class="reservation-status">전체 <span class="_count text-primary">0</span></a></li></ul></div><div class="owl-item active" style="width: auto; margin-right: 0px;"><ul class="owl-nav-tabs"><li class=" _PAY_WAIT"><a href="#" onclick="location.href='./order?status=PAY_WAIT&amp;q_enc=YjowOw%3D%3D'" data-name="입금대기" class="reservation-status">입금대기 <span class="_count text-primary">0</span></a></li></ul></div><div class="owl-item" style="width: auto; margin-right: 0px;"><ul class="owl-nav-tabs"><li class=" _COMPLETE"><a href="#" onclick="location.href='./order?status=COMPLETE&amp;q_enc=YjowOw%3D%3D'" data-name="예약완료" class="reservation-status">예약완료 <span class="_count text-primary">0</span></a></li></ul></div><div class="owl-item" style="width: auto; margin-right: 0px;"><ul class="owl-nav-tabs"><li class=" _CANCEL"><a href="#" onclick="location.href='./order?status=CANCEL&amp;q_enc=YjowOw%3D%3D'" data-name="취소완료" class="reservation-status">취소완료 <span class="_count text-primary">0</span></a></li></ul></div><div class="owl-item" style="width: auto; margin-right: 0px;"><ul class="owl-nav-tabs"><li class=" _CLAIM_STATUS_CANCEL_REQUEST"><a href="#" onclick="location.href='./order?status=CLAIM_STATUS_CANCEL_REQUEST&amp;q_enc=YjowOw%3D%3D'" data-name="취소요청" class="reservation-status">취소요청 <span class="_count text-primary">0</span></a></li></ul></div><div class="owl-item" style="width: auto; margin-right: 0px;"><ul class="owl-nav-tabs"><li class=" _CLAIM_STATUS_CANCELING"><a href="#" onclick="location.href='./order?status=CLAIM_STATUS_CANCELING&amp;q_enc=YjowOw%3D%3D'" data-name="취소처리중" class="reservation-status">취소처리중 <span class="_count text-primary">0</span></a></li></ul></div><div class="owl-item" style="width: auto; margin-right: 0px;"><ul class="owl-nav-tabs"><li class=" _CLAIM_STATUS_CANCEL_FAILED"><a href="#" onclick="location.href='./order?status=CLAIM_STATUS_CANCEL_FAILED&amp;q_enc=YjowOw%3D%3D'" data-name="취소처리실패" class="reservation-status">취소처리실패 <span class="_count text-primary">0</span></a></li></ul></div></div></div><div class="owl-controls"><div class="owl-nav"><div class="owl-prev" style="display: none;">prev</div><div class="owl-next" style="display: none;">next</div></div><div class="owl-dots" style=""><div class="owl-dot active"><span></span></div><div class="owl-dot"><span></span></div><div class="owl-dot"><span></span></div><div class="owl-dot"><span></span></div><div class="owl-dot"><span></span></div><div class="owl-dot"><span></span></div><div class="owl-dot"><span></span></div></div></div></li>
					</ul>
					<div class="row">
						<div class="col-md-12">
							<div class="card">
								<div class="card-body no-padding">
									<form role="search" class="prod-search" id="order_search_form" onsubmit="return false;">
											...
											<span class="twitter-typeahead" style="position: relative; display: inline-block;">
												<input type="text" class="_keyword_search form-control typeahead tt-input" placeholder="검색어를 입력해주세요 (예약번호, 예약자명, 전화번호, 이메일)" autocomplete="off" spellcheck="false" dir="auto" style="position: relative; vertical-align: top; border: none; background-color: transparent; padding-left: 0" onkeydown="if (event.keyCode==13) BOOKING_ORDER_LIST.startKeywordSearch()" value="">
											</span>
										</div>
										...
										<div class="serach_wrap">
											<div class="dd-filter-serach">
												<label class="icon_set">
													<i class="btl bt-search" onclick="BOOKING_ORDER_LIST.startKeywordSearch()"></i>
												</label>
												<!--<a class="text-primary" href="javascript:;" onclick="alert('준비중입니다')">이 검색을 저장</a>-->
											</div>
										</div>
									</form>
								</div>
					...
					<div class="card style-transparent card-top no-tab" style="" id="order_list_no_order">
						<div class="card-head">
							<header class="style-price-header force-padding">
								<h2>접수된 예약이 없습니다.</h2>
								<div class="sub-title text-gray-bright text-center" style="font-size: 18px;">예약이 접수되면 이곳에서 실시간으로 확인할 수 있습니다.</div>
							</header>
						</div>
					</div>
					<div class="card" id="order_list_card" style="display: none">
						<div class="table-responsive shop-table orders check" id="order_list">
							<div class="table-btn-group">
								<div class="btn-group-left">
									<div class="btn-group">
										<a href="javascript:;" onclick="BOOKING_ORDER_LIST.runOrderAction('SEND_COMPLETE')" class="btn btn-white btn-sm btn-sm-padding" data-toggle="tooltip" data-placement="top" title="" data-original-title="입금대기상태의 예약신청을 입금확인처리 합니다.">예약완료 처리</a>

										<a href="javascript:;" onclick="BOOKING_ORDER_LIST.runOrderAction('ADMIN_CANCEL')" class="btn btn-white btn-sm btn-sm-padding" data-toggle="tooltip" data-placement="top" title="" data-original-title="관리자께서 예약을 수동으로 취소합니다.">예약취소</a>
										<a href="javascript:;" onclick="BOOKING_ORDER_LIST.runOrderAction('CANCEL_ACCEPT')" class="btn btn-white btn-sm btn-sm-padding" data-toggle="tooltip" data-placement="top" title="" data-original-title="예약 취소 신청건에 대해 예약 취소를 승인합니다.">예약취소승인</a>
										<a href="javascript:;" onclick="BOOKING_ORDER_LIST.runOrderAction('CANCEL_REJECT')" class="btn btn-white btn-sm btn-sm-padding" data-toggle="tooltip" data-placement="top" title="" data-original-title="예약 취소 신청건에 대해 거절 처리합니다.">예약취소거절</a>
										<div class="holder inline-blocked btn btn-white btn-sm btn-sm-padding no-padding">
											<a href="javascript:;" style="display: block; padding:2px 15px;" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">기타 예약취소처리 <span class="caret"></span></a>

											<ul class="dropdown-menu">
												<li><a href="javascript:;" onclick="BOOKING_ORDER_LIST.runOrderAction('RESTORE_CANCELING')" data-toggle="tooltip" data-placement="right" title="" data-original-title="취소완료건을 취소 처리중으로 되돌립니다. 이미 환불이 완료된 경우 대금이 회수되지 않습니다.">취소처리중으로 되돌리기</a></li>
												<li><a href="javascript:;" onclick="BOOKING_ORDER_LIST.runOrderAction('RESTORE_CANCEL_REQUEST')" data-toggle="tooltip" data-placement="right" title="" data-original-title="취소완료, 취소처리중을 취소 요청으로 되돌립니다. 이미 환불이 완료된 경우 대금이 회수되지 않습니다.">취소요청으로 되돌리기</a></li>
												<li><a href="javascript:;" onclick="BOOKING_ORDER_LIST.runOrderAction('CANCEL_RETRY')" data-toggle="tooltip" data-placement="right" title="" data-original-title="자동환불이 지원되는 결제(신용카드)의 취소처리를 하였으나 카드사 장애 등의 이유로 취소처리중으로 되었을 때 자동 환불을 다시 시도합니다.">자동환불 재시도</a></li>
												<li><a href="javascript:;" onclick="BOOKING_ORDER_LIST.runOrderAction('CANCEL_DONE')" data-toggle="tooltip" data-placement="right" title="" data-original-title="자동환불이 불가한 경우 수동으로 실제 환불을 처리하신 후 주문서를 취소완료 상태로 변경하는 기능입니다. 자동환불이 진행되지 않으므로 구매자와 협의된 방법으로 환불을 별도 진행해 주셔야 합니다.">강제 취소(환불)완료 처리</a></li>
											</ul>
										</div>
									</div>
								</div>
								<div class="btn-group-right">
									<div class="holder inline-blocked excel_down_btn">
                                        											<a href="javascript:;" onclick="BOOKING_ORDER_LIST.openModalOrderExcelDownload()" type="button" class="btn btn-sm btn-sm-padding btn-default-bright">
							...
							<table class="table no-margin">
								...
								<tr>
									<th class="text-center">
											...
											<label>
												<input type="checkbox" id="order_list_allcheck" onclick="BOOKING_ORDER_LIST.toggleAllSelected()">
												<span></span>
											</label>
										</div>
																			</th>
						...
						<nav class="text-center" id="order_list_paging">
							<!--
							<ul class="pagination">
								<li class="prev"><a href="javascript:;"><i class="zmdi zmdi-chevron-left"></i></a></li>
								<li class="active"><a href="javascript:;">1</a></li>
								<li><a href="javascript:;">2</a></li>
								<li class="next disabled"><a href="javascript:;"><i class="zmdi zmdi-chevron-right"></i></a>
								</li>
							</ul>
							-->
						</nav>
...
<script>
	$(function(){
		BOOKING_ORDER_LIST.initList();
		BOOKING_ORDER_LIST.loadList('1', {'status':'','keyword':''}, "/admin/booking/order/?q=YjowOw%3D%3D");
	});
...
<script>
</script><div style="position: absolute; width: 1px; height: 1px; left: -10000px;" data-ip="220.117.144.98" data-ip2="" data-ip3="220.117.144.98, 130.176.126.102"><input id="dummy_input" type="text"></div>
