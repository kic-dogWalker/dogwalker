...
<tr valign="middle" bgcolor="#ffffff"><td>
	...
	<div class="container text-center border border-2 cm-1">
		...
		<p>
			<div class="row">
				<div class="col-2"></div>
				<div class="col-4"><img src="../resources/img/SU.png" style="width: 300px;height:300px;" class="rounded-circle" alt="..."></div>
				<div class="col-4"><img src="../resources/img/GGO.png" style="width: 300px;height:300px;" class="rounded-circle" alt="..."></div>
				<div class="col-2"></div>
			</div><!-- row -->
			<div class="row">
				<div class="col-2"></div>
			...
			<div class="row">
			<div class="col-2"></div>
				<div class="col-4"><button type="button" class="btn btn-primary" onclick ="location.href = 'WalkingStatusDone.html' ">산책종료</button></div>
				<div class="col-4">
					<!-- 모달 시작 -->
					  ...
					  <div class="modal-dialog">
					    <div class="modal-content">
					      ...
					      <div class="modal-footer">
					        ...
					        <button type="button" class="btn btn-danger">제출 후 산책 취소하기</button>
					      </div>
					    </div>
					  </div>
					</div>
